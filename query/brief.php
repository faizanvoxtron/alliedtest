...
<head>
    <title>Brief Form | Allied IP Firm</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                            ...
                            <div class="row">
                                ...
                                <div class="row" id="CustomerInfo">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                                        <div class="mb-3">
                                            <label for="CustomerPhone" class="form-label">Enter Your City.<span class="sub-text" style="font-size: 24px;">*</span></label>
                                            <input class="form-control" type="text" id="CustomerCity" name="CustomerCity" placeholder="Enter Your City." maxlength="20">
                                        </div>
                                    </div>
                                     <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                                        <div class="mb-3">
                                            <label for="CustomerPhone" class="form-label">Enter Your Street Address.<span class="sub-text" style="font-size: 24px;">*</span></label>
                                            <input class="form-control" type="text"  id="CustomerAddress" name="CustomerAddress" placeholder="Enter Your States." maxlength="100">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                                        <div class="mb-3">
                                            <label for="CustomerPhone" class="form-label">Zip Code / Postal Code.<span class="sub-text" style="font-size: 24px;">*</span></label>
                                            <input class="form-control" type="text"  id="CustomerZipCode" name="CustomerZipCode" placeholder="Enter Your States." maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                                        <div class="mb-3">
                                            <label for="CustomerPhone" class="form-label">Enter Your State.<span class="sub-text" style="font-size: 24px;">*</span></label>
                                            <input class="form-control" type="text" id="CustomerState" name="CustomerState" placeholder="Enter Your States." maxlength="20">
                                        </div>
                                    </div>
                                ...
                                <ul class="asstxt">
                                    <li>
                                        <a href="tel:4085388655">
                                            ...
                                            <span>Toll Free:</span> (408) 538-8655 </a>
                                    </li>
                                    <br>
                                    <li>
