                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                            ...
                                            <input class="from-control" type="text" id="ProtectName" name="ProtectName" placeholder="What is the Title of the Work You Would like to Copyright?" required="">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                            ...
                                            <select class="from-control" id="ProtectSlogan" name="ProtectSlogan" required="">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                            ...
                                            <div class="d-flex inline-block">
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" type="radio" id="SelectTrademark" value="Yes" name="SelectTrademark" required="">
                                                <label for="Publish1">Yes</label>
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" type="radio" id="CustomerName" value="No" name="CustomerName" checked="" required="">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                            ...
                                            <div class="d-flex inline-block">
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" type="radio" id="CustomerEmail" value="Yes" name="CustomerEmail" required="">
                                                <label for="Publish3">Yes</label>
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" type="radio" id="CustomerPhone" value="No" name="CustomerPhone" checked="" required="">
                                    ...
                                    <div class="row" id="CustomerInfo">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                            ...
                                            <select class="from-control" id="OrganizationType" name="OrganizationType" required="">
                                                <option value="" selected="">Choose...</option>
