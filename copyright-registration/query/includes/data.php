...
if ($_GET['package'] == "Deluxe Package") {
...
$tmbasic = array('<b>Professional Preparation</b> of your federal copyright application including a review by the copyright team for accuracy, completeness and common mistakes.', '<b>Federal E-Filing</b> Electronic filing of your application with the U.S Copyright Office with no need to wait for mail or dealing with paper files', '<b>Certificate of Registration</b> of your federal copyright application including a review by the copyright team for accuracy, completeness and common mistakes.');
$tmprofessional = array('<b>Cease & Desist Letter</b> A customer-specific form you can further customize if someone is infringing on your copyright.', '<b>Transfer/Assignment</b> Custom assignment template. If you need to sell or otherwise convey your copyright, you have access to your pre-filled in template that you can further customize.', '<b>24-hour Expedited Processing</b> of the preparation of your copyright application. Normal processing time is 5 business days in our Basic package.');
...
$packages = array('Basic Package', 'Deluxe Package');
