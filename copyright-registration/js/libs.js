...
!(function (e, t) {
  ...
  var t,
    ...
    E = function (e, t, n, r) {
      ...
      return (
        t
          ...
          .forEach(function (e) {
            _(s.inner, Object.assign({}, e.inner)),
              _(s.outer, Object.assign({}, e.outer));
          }),
        T(s.inner),
        ...
        return (
          ...
          }),
          {
            write: function () {
              if (y(u, n))
                return (
                  D(i.element, n), Object.assign(u, Object.assign({}, n)), !0
                );
            },
            destroy: function () {},
          }
              ...
              return (
                ...
                h.forEach(function (r, i) {
                  r.element.parentNode ||
                    (j.appendChild(r.element, i),
                    r._read(),
                    r._write(e, R(r, t), n),
                    (o = !1));
                }),
                (m = o),
                b({ props: r, root: j, actions: t, timestamp: e }),
                o
              );
            },
            _destroy: function () {
    ...
    j = function (e) {
      ...
      var t = G(e).trim();
      return /MB$/i.test(t)
        ? ((t = t.replace(/MB$i/, "").trim()), 1e3 * F(t) * 1e3)
        : /KB/i.test(t)
        ? ((t = t.replace(/KB$i/, "").trim()), 1e3 * F(t))
        : F(t);
    },
    k = function (e) {
      ...
      return {
        ...
        GET_PANEL_ASPECT_RATIO: function () {
          return /circle/.test(e.options.stylePanelLayout)
            ? 1
            : ye(e.options.stylePanelAspectRatio);
        },
        ...
        IS_ASYNC: function () {
          return (
            z(e.options.server) &&
            (z(e.options.server.process) || k(e.options.server.process))
          );
        },
      };
    };
  ...
  "function" == typeof Symbol &&
    ...
    (Ge.prototype[Symbol.asyncIterator] = function () {
      return this;
    }),
  ...
  var qe = function (e, t, n) {
    ...
    tt = function (e, t, n) {
      ...
      return (
        ...
        a.open(n.method, t, !0),
        Y(n.timeout) && (a.timeout = n.timeout),
            ...
            return function (o, i, a, u, s, l, c) {
              if (o) {
                ...
                var E =
                  ...
                  v = new FormData();
                z(i) && v.append(n, JSON.stringify(i)),
              ...
              (t.request = e(
                ...
                function (e) {
                  t.perceivedPerformanceUpdater.clear(),
                    r.fire(
                      "error",
                      z(e) ? e : { type: "error", code: 0, body: "" + e }
                    );
                },
                function (e, n, r) {
                  (t.duration = Date.now() - t.timestamp),
                ...
                i.file
                  ...
                  : ((i.file = (function (e) {
                    ...
                    n.on("meta", function (t) {
                      (i.file.size = t.size),
                        ...
                        t.source &&
                          ...
                          (i.status = de.PROCESSING_COMPLETE)),
                        l("load-meta");
                    }),
                    ...
                    n.on("load", function (t) {
                      i.activeLoader = null;
                      var n = function (t) {
                        (i.file = It(t) ? t : i.file),
                          e === pe.LIMBO && i.serverFileReference
                            ? s(de.PROCESSING_COMPLETE)
                            : s(de.IDLE),
                          l("load");
                      };
      ...
      return {
          ...
          i.forEach(function (t) {
            ...
            o.forEach(function (t, n) {
              i.find(function (e) {
                ...
                e(
                  "ADD_ITEM",
                  Object.assign({}, t, { interactionMethod: ie, index: n })
                );
            });
        },
          ...
          clearTimeout(n.itemUpdateTimeout),
            (n.itemUpdateTimeout = setTimeout(function () {
              ...
              if (t("IS_ASYNC")) {
                ...
                return r.status === de.PROCESSING_COMPLETE
                  ? ((i = n.options.instantUpload),
                    void r
                      .revert(
                        Et(n.options.server.url, n.options.server.revert),
                        t("GET_FORCE_REVERT")
                      )
                      .then(i ? a : function () {})
                      .catch(function () {}))
                  : r.status === de.PROCESSING
                  ? (function (e) {
                      r.abortProcessing().then(e ? a : function () {});
                    })(n.options.instantUpload)
                  : void (n.options.instantUpload && a());
              }
              Ie("SHOULD_PREPARE_OUTPUT", !1, { item: r, query: t }).then(
                function (t) {
                  t &&
                    e(
        ...
        MOVE_ITEM: function (e) {
          ...
          if (o) {
            ...
            i !== (r = qe(r, 0, n.items.length - 1)) &&
              n.items.splice(r, 0, n.items.splice(i, 1)[0]);
          }
        },
        SORT: function (r) {
          var o = r.compare;
          St(n, o), e("DID_SORT_ITEMS", { items: t("GET_ACTIVE_ITEMS") });
        },
        ...
        ADD_ITEM: function (r) {
          var o = r.source,
            ...
            d = r.options,
            p = void 0 === d ? {} : d;
          if (C(o)) f({ error: nt("error", 0, "No source"), file: null });
          else if (
            !It(o) ||
            ...
            if (
              ...
              var _ = De(n.items)[0];
              if (
                _.status === de.PROCESSING_COMPLETE ||
                _.status === de.PROCESSING_REVERT_ERROR
              ) {
            ...
            Object.keys(p.metadata || {}).forEach(function (e) {
              ...
              me("DID_CREATE_ITEM", I, { query: t, dispatch: e });
            ...
            I.on("load-init", function () {
              ...
              I.on("load", function () {
                ...
                Ie("DID_LOAD_ITEM", I, { query: t, dispatch: e })
                  .then(function () {
            ...
            I.load(
              ...
              function (e, n, r) {
                Ie("LOAD_FILE", e, { query: t }).then(n).catch(r);
              }
            );
          }
        },
        REQUEST_PREPARE_OUTPUT: function (e) {
          ...
          Ie("PREPARE_OUTPUT", n.file, { query: t, item: n }).then(function (
            e
          ) {
            Ie("COMPLETE_PREPARE_OUTPUT", e, { query: t, item: n }).then(
              function (e) {
                if (n.archived) return i(a);
                r(e);
              }
        ...
        REQUEST_ITEM_PROCESSING: At(n, function (r, o, i) {
          if (r.status === de.IDLE || r.status === de.PROCESSING_ERROR)
            r.status !== de.PROCESSING_QUEUED &&
              (r.requestProcessing(),
            ...
            r.status === de.PROCESSING_COMPLETE ||
            r.status === de.PROCESSING_REVERT_ERROR
              ? r
                  .revert(
                    Et(n.options.server.url, n.options.server.revert),
                    t("GET_FORCE_REVERT")
                  ...
                  .then(u)
                  .catch(function () {})
              : r.status === de.PROCESSING && r.abortProcessing().then(u);
          }
        }),
          ...
          if (t("GET_ITEMS_BY_STATUS", de.PROCESSING).length !== a) {
            if (r.status !== de.PROCESSING) {
              ...
              r.process(
                ...
                function (n, o, i) {
                  Ie("PREPARE_OUTPUT", n, { query: t, item: r })
                    .then(function (t) {
        ...
        REMOVE_ITEM: At(n, function (r, o, i, a) {
          ...
          r.origin === pe.LOCAL && s && k(s.remove)
        ...
        SET_OPTIONS: function (t) {
          var n = t.options;
          r(n, function (t, n) {
            e("SET_" + K(t, "_").toUpperCase(), { value: n });
          });
        },
      };
    },
    ...
    Yt = function (e) {
      var t = e.root,
        n = e.props;
      Y(t.query("GET_ITEM_SIZE", n.id)) ||
        Mt(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"));
    },
    jt = b({
      name: "file-info",
      ignoreRect: !0,
      ...
      didCreateView: function (e) {
        me("CREATE_VIEW", Object.assign({}, e, { view: e }));
      },
      create: function (e) {
        var t = e.root,
          n = e.props,
        ...
        (o.className = "filepond--file-info-sub"),
          t.appendChild(o),
          (t.ref.fileSize = o),
          Mt(o, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")),
          Mt(r, Lt(t.query("GET_ITEM_NAME", n.id)));
      },
      mixins: {
      ...
      var t = e.root,
        ...
        r =
          null === n.progress
            ...
            : t.query("GET_LABEL_FILE_LOADING") + " " + kt(n.progress) + "%";
  ...
  var Zt,
    ...
    an = {
      ...
      DID_START_ITEM_REMOVE: {
        processProgressIndicator: { opacity: 1, align: tn },
        info: { translateX: Kt },
        status: { opacity: 0 },
      },
      DID_THROW_ITEM_REMOVE_ERROR: {
        processProgressIndicator: { opacity: 0, align: tn },
        buttonRemoveItem: { opacity: 1 },
        info: { translateX: Kt },
    ...
    ln = b({
      create: function (e) {
        ...
        if (
          (i &&
            o &&
            ((Qt.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM"),
            (Qt.RevertItemProcessing.icon = "GET_ICON_REMOVE")),
          a && !o)
        ) {
          s.splice(-1, 1);
          var l = an.DID_COMPLETE_ITEM_PROCESSING;
          (l.info.translateX = en),
            (l.info.translateY = Jt),
            (l.status.translateY = Jt),
        ...
        if (u && o) {
          ...
          (c.info.translateX = Kt),
            (c.status.translateY = Jt),
        ...
        r(Qt, function (e, r) {
          ...
          s.includes(e) && t.appendChildView(o),
        ...
        d.element.classList.add("filepond--process-indicator"),
          (t.ref.processProgressIndicator = d),
          (t.ref.activeStyles = []);
      },
      write: function (e) {
        var t = e.root,
    ...
    cn = b({
      create: function (e) {
        var t = e.root,
          n = e.props;
        (t.ref.fileName = Pt("legend")),
          t.appendChild(t.ref.fileName),
          (t.ref.file = t.appendChildView(t.createChildView(ln, { id: n.id }))),
          (t.ref.data = !1);
      },
      ignoreRect: !0,
      write: L({
    ...
    fn = { type: "spring", damping: 0.6, mass: 7 },
    dn = function (e, t, n) {
      var r = b({
      ...
      write: function (e) {
        ...
        if (
          ((null !== t.ref.scalable && n.scalable === t.ref.scalable) ||
            ((t.ref.scalable = !U(n.scalable) || n.scalable),
      ...
      create: function (e) {
        ...
        [
          ...
          },
          {
            ...
            mixins: { animations: { translateY: fn }, styles: ["translateY"] },
          },
        ].forEach(function (e) {
          dn(t, e, n.name);
        }),
    ...
    En = { type: "spring", stiffness: 0.75, damping: 0.45, mass: 10 },
    _n = {
      ...
      create: function (e) {
        ...
        (t.ref.handleClick = function (e) {
          ...
          (t.ref.panel = t.appendChildView(
            t.createChildView(pn, { name: "item-panel" })
          )),
            ...
            t.element.addEventListener("pointerdown", function (e) {
              if (e.isPrimary) {
                ...
                (n.dragOrigin = { x: t.translateX, y: t.translateY }),
                  ...
                  t.dispatch("DID_GRAB_ITEM", { id: n.id });
                var a = function (e) {
                  e.isPrimary &&
                    (e.stopPropagation(),
                    e.preventDefault(),
                    ...
                    t.dispatch("DID_DRAG_ITEM", { id: n.id }));
                };
                document.addEventListener("pointermove", a),
                  document.addEventListener("pointerup", function e(u) {
                    u.isPrimary &&
                      (document.removeEventListener("pointermove", a),
                      document.removeEventListener("pointerup", e),
                      (n.dragOffset = { x: u.pageX - o, y: u.pageY - i }),
                      t.dispatch("DID_DROP_ITEM", { id: n.id }),
                      r &&
                        setTimeout(function () {
      ...
      e.dragOffset
        ...
        : ((e.translateX = t),
          ...
          Date.now() > e.spawnDate &&
            (0 === e.opacity && hn(e, t, n, r, o),
            (e.scaleX = 1),
            (e.scaleY = 1),
            (e.opacity = 1)));
    },
    hn = function (e, t, n, r, o) {
      e.interactionMethod === ie
        ? ((e.translateX = null),
          (e.translateX = t),
          (e.translateY = null),
          (e.translateY = n))
    ...
    On = L({
      ...
      DID_DRAG_ITEM: function (e) {
        ...
        if (o) {
          for (
            var i = o.dragOrigin.y + o.dragOffset.y + o.dragCenter.y,
          ...
          t.dispatch("MOVE_ITEM", { query: o, index: c }),
            p !== c &&
    ...
    wn = function (e) {
      var t = e.root;
      e.action.value
        ? 0 === t.query("GET_TOTAL_ITEMS") && An(t.element, "required", !0)
        : An(t.element, "required", !1);
    },
    Cn = function (e) {
      var t = e.root,
        n = e.action;
    ...
    Nn = function (e) {
      ...
      t.query("GET_TOTAL_ITEMS") > 0
        ? (An(n, "required", !1), An(n, "name", !1))
        : (An(n, "name", !0, t.query("GET_NAME")),
          t.query("GET_CHECK_VALIDITY") && n.setCustomValidity(""),
          t.query("GET_REQUIRED") && An(n, "required", !0));
    },
    Gn = b({
      tag: "input",
      name: "browser",
      ...
      create: function (e) {
        ...
        (t.element.id = "filepond--browser-" + n.id),
          ...
          Ln({ root: t, action: { value: t.query("GET_ALLOW_MULTIPLE") } }),
          Pn({
            root: t,
            action: { value: t.query("GET_ALLOW_DIRECTORIES_ONLY") },
          }),
          Mn({ root: t }),
          wn({ root: t, action: { value: t.query("GET_REQUIRED") } }),
          Cn({ root: t, action: { value: t.query("GET_CAPTURE_METHOD") } }),
    ...
    rr = function (e) {
      ...
      var t = e.lastModifiedDate,
        n = e.name;
      return (
        ((e = e.slice(0, e.size, $n(Ye(e.name)))).name = n),
        ...
        Zn(n).then(function (r) {
          ...
          t.some(function (t) {
            ...
            if (f)
              if (Er(e, a)) {
                if (((o = !0), null === t.state))
                  return (t.state = "enter"), void u(fr(e));
                if (((t.state = "over"), i && !f)) return void Tr(n, "none");
                l(fr(e));
              } else
                i && !o && Tr(n, "none"),
                  t.state && ((t.state = null), s(fr(e)));
            else Tr(n, "none");
          });
        });
      };
        ...
        Zn(n).then(function (n) {
          t.forEach(function (t) {
            var r = t.filterElement,
              ...
              a = t.onexit,
              u = t.allowdrop;
            if (((t.state = null), !r || Er(e, o)))
              return u(n) ? void i(fr(e), n) : a(fr(e));
          });
        });
      };
    },
        ...
        t = {
          destroy: function () {
            ...
            (t = e),
              ue(Or, Or.indexOf(t)),
              0 === Or.length &&
                (document.removeEventListener("paste", yr), (Rr = !1));
          },
          onload: function () {},
        };
      return (
        (function (e) {
          Or.includes(e) ||
            (Or.push(e),
            Rr || ((Rr = !0), document.addEventListener("paste", yr)));
        })(e),
        t
      );
    },
          ...
          if (Mr(t)) {
            ...
            br.push(r.filename),
              ...
              (Sr = setTimeout(function () {
                Pr(t, br.join(", "), t.query("GET_LABEL_FILE_ADDED")),
                  (br.length = 0);
              }, 750));
          }
        },
    ...
    jr = function (e) {
      ...
      if (r && !e.ref.hopper) {
        ...
        (o.onload = function (t, n) {
          ...
          (e.ref.hopper = o),
          (e.ref.drip = e.appendChildView(e.createChildView(Yn)));
      } else
        !r &&
          e.ref.hopper &&
      ...
      create: function (e) {
        ...
        o &&
          ...
          (t.ref.list = t.appendChildView(
            t.createChildView(Sn, { translateY: null })
          )),
          (t.ref.panel = t.appendChildView(
            t.createChildView(pn, { name: "panel-root" })
          )),
          (t.ref.assistant = t.appendChildView(
            t.createChildView(Nr, Object.assign({}, n))
          )),
          (t.ref.data = t.appendChildView(
            t.createChildView(Xn, Object.assign({}, n))
          )),
        ...
        t.query("GET_ALLOW_REORDER") &&
          a &&
          !i &&
          (t.element.addEventListener("touchmove", Br, { passive: !1 }),
      ...
      write: function (e) {
        ...
        if (
          ...
          var T = Vr(t),
            ...
            O = m + g + v.bounds + h;
          if (
            ((s.translateY = Math.max(0, m - s.rect.element.marginTop) - T.top),
            c)
          ) {
            ...
            v.visual > M ? (s.overflow = M) : (s.overflow = null),
              (t.height = D);
            ...
            (l.scalable = !0),
              (l.height = Math.max(I, R - B)),
              (t.height = Math.max(I, O - B));
          }
        }
      },
      destroy: function (e) {
        ...
        t.ref.paster && t.ref.paster.destroy(),
          ...
          t.element.removeEventListener("touchmove", Br),
          t.element.removeEventListener("gesturestart", Br);
      },
      ...
      var p = zr(i, { id: ae() }),
        ...
        T = {
          _read: function () {
            s &&
              ...
              _ && E && (E = null === p.element.offsetParent),
              E || (p._read(), (_ = p.rect.element.hidden));
          },
          _write: function (e) {
            var t,
        ...
        I = function (e) {
          return function (t) {
            ...
            return (
              t.items && (n.items = t.items.map(fe)),
            ...
            return (
              r(t, function (t) {
                n[t] = {
                  ...
                  set: function (n) {
                    e.dispatch("SET_" + K(t, "_").toUpperCase(), { value: n });
                  },
                };
              }),
              n
            ...
            processFiles: function () {
              ...
              if (!r.length) {
                var o = y().filter(function (e) {
                  return (
                    !(e.status === de.IDLE && e.origin === pe.LOCAL) &&
                    e.status !== de.PROCESSING &&
                    e.status !== de.PROCESSING_COMPLETE &&
                    e.status !== de.PROCESSING_REVERT_ERROR
                  );
                });
      ...
      return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof
        ...
        ? function (e) {
            ...
            Object.keys(o).forEach(function (e) {
              z(o[e])
                ? (z(r[e]) || (r[e] = {}), Object.assign(r[e], o[e]))
                : (r[e] = o[e]);
            }),
  ...
  if (
    ...
    (e.Status = Object.assign({}, Se)),
      (e.FileOrigin = Object.assign({}, pe)),
      (e.FileStatus = Object.assign({}, de)),
      (e.OptionTypes = {}),
      fo(),
      (e.create = function () {
