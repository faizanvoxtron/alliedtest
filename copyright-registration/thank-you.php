...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="query/assets/css/service-style.css">
        ...
        <div class="row">
          <div class=col-md-6>
            <div class="logo-wrapper">
              <a href="#_"><img src="query/assets/images/logo-white.svg" class="img-fluid" alt="Logo"></a>
            </div>
          </div>
          <div class=col-md-6>
            ...
            <a href="tel:(800) 291-3781" class="get-quote c-button js-next-screen shine float-right"><i class="fa-solid fa-phone me-2"></i>(800) 291-3781</a>
          </div>
        </div>
      </div>
    </header>
                  ...
                  <div class="col-md-4 col-sm-4">
                    <div class="icon-box rounded-red">
                      <a href="tel:(800) 291-3781">
                        ...
                        <p>Toll Free<br>
                          <span><a href="tel:(800) 291-3781">(800) 291-3781</a></span>
                        </p>
                      </a>
                    </div>
                  </div>
