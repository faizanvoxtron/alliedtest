...
<head>
    ...
    $pageTitle = "Terms & Conditions | Allied IP Firm";
    // $pageKeywords = '';
    // $pageDescription = "";
    $pageCanonical = 'https://alliedipfirm.com/terms-conditions';
	...
	<div class="container h-100">
		<div class="row justify-content-center align-items-center h-100">
			<div class="services-cont text-center">
				<h1 class="cl-white">Terms and Conditions</h1>
			</div>
		</div>
	</div>
</div>
...
<div class="page-title-area item-bg1 jarallax" data-jarallax='{"speed": 0.3}'>
	<div class="container">
		<div class="page-title-content">
			...
			<h3 class="clr-pp">Terms and Conditions</h3>
...
<p>THE RIGHT TO OPT OUT OF BINDING ARBITRATION AND CLASS ACTION WAIVER WITHIN 30 DAYS. IF YOU DO NOT WISH TO BE BOUND BY THE BINDING ARBITRATION AND CLASS ACTION WAIVER IN THIS SECTION, YOU ARE REQUIRED TO NOTIFY US IN WRITING WITHIN 30 DAYS OF THE DATE THAT YOU ACCEPT THIS AGREEMENT. YOUR WRITTEN NOTIFICATION MUST BE E-MAILED TO Allied IP Firm, LLC, legal@alliedipfirm.com WITH THE SUBJECT LINE “OPT-OUT’ AND INCLUDE: (1) YOUR NAME, (2) YOUR ADDRESS, AND (4) A CLEAR STATEMENT THAT YOU DO NOT WISH TO RESOLVE DISPUTES WITH US THROUGH ARBITRATION.</p>
