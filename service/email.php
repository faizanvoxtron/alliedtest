...
function email($id,$table,$emailId) {
    ...
    if ($table == "leads") {
        ...
        $customerNotification = "Please process the required information.<br><br>OR<br><br>Call us now at Tollfree:<a style='text-decoration:none; color:red; font-weight:bold;' href='tel:4085388655'> (408) 538-8655</a>";
    ...
    if ($table == "payIntents") {
        ...
        $customerNotification = "Thank you for processing the payment.<br>Your Dedicated Account Manager will contact you shortly.<br><br>OR<br><br>Call us any time at Tollfree:<a style='text-decoration:none; color:red; font-weight:bold;' href='tel:4085388655'> (408) 538-8655</a>";
...
function SendCompany($title, $ctx, $subtitle,  $url, $notification, $html, $emailId, $emailTitle, $customerTitle, $customerSubtitle, $customerNotification, $email ) {
    ...
    $replace = Array( $title, "https://alliedipfirm.com/query/assets/images/email-logo.png", "Allied IP Firm", "9515 Debbie Lane Orland Park, IL 60467", "(408) 538-8655", "support@alliedipfirm.com", $subtitle, $url, $notification );
    ...
    try {
        ...
        $mail->Username = "sales@alliedipfirm.com";
        $mail->Password = "Sal3$#1^2";
        $mail->setFrom('sales@alliedipfirm.com', 'Allied IP Firm');
...
function SendCustomer($emailTitle, $title, $subtitle, $notification, $email, $emailId, $ctx) {
    ...
    $replace = Array( $title, "https://alliedipfirm.com/query/assets/images/email-logo.png", "Allied IP Firm", "9515 Debbie Lane Orland Park, IL 60467", "(408) 538-8655", "support@alliedipfirm.com", $subtitle, $notification );
