...
$sql = "SELECT DISTINCT leads.name, sheet_for_brief.email, leads.id, leads.phone, leads.status FROM leads INNER JOIN sheet_for_brief ON sheet_for_brief.email=leads.email";
